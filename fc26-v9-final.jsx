...
const PLAYERS = [
  {id:1,  n:"Kylian Mbappé",         s:"Mbappé",      pos:"ST",  r:91,pac:97,sho:90,pas:80,dri:92,def:39,phy:76,sm:5,wf:4,club:"Real Madrid",   nat:"🇫🇷",cat:"M"},
  {id:2,  n:"Mohamed Salah",         s:"Salah",       pos:"RM",  r:91,pac:90,sho:88,pas:81,dri:90,def:46,phy:77,sm:4,wf:3,club:"Liverpool",     nat:"🇪🇬",cat:"M"},
  {id:3,  n:"Ousmane Dembélé",       s:"Dembélé",     pos:"ST",  r:90,pac:91,sho:88,pas:77,dri:93,def:33,phy:68,sm:4,wf:4,club:"Paris SG",      nat:"🇫🇷",cat:"M"},
  {id:4,  n:"Erling Haaland",        s:"Haaland",     pos:"ST",  r:90,pac:89,sho:91,pas:65,dri:80,def:45,phy:88,sm:3,wf:3,club:"Man City",      nat:"🇳🇴",cat:"M"},
  {id:5,  n:"Virgil van Dijk",       s:"Van Dijk",    pos:"CB",  r:90,pac:79,sho:61,pas:73,dri:63,def:90,phy:90,sm:2,wf:3,club:"Liverpool",     nat:"🇳🇱",cat:"M"},
  {id:6,  n:"Jude Bellingham",       s:"Bellingham",  pos:"CAM", r:90,pac:80,sho:83,pas:87,dri:88,def:75,phy:82,sm:4,wf:4,club:"Real Madrid",   nat:"🏴󠁧󠁢󠁥󠁮󠁧󠁿",cat:"M"},
  {id:7,  n:"Rodri",                 s:"Rodri",       pos:"CDM", r:90,pac:64,sho:72,pas:91,dri:81,def:91,phy:82,sm:3,wf:4,club:"Man City",      nat:"🇪🇸",cat:"M"},
  {id:8,  n:"Harry Kane",            s:"Kane",        pos:"ST",  r:89,pac:71,sho:92,pas:84,dri:81,def:48,phy:84,sm:3,wf:4,club:"Bayern Munich", nat:"🏴󠁧󠁢󠁥󠁮󠁧󠁿",cat:"M"},
  {id:9,  n:"Vinicius Júnior",       s:"Vini Jr.",    pos:"LW",  r:89,pac:95,sho:84,pas:79,dri:91,def:35,phy:73,sm:5,wf:3,club:"Real Madrid",   nat:"🇧🇷",cat:"M"},
  {id:10, n:"Thibaut Courtois",      s:"Courtois",    pos:"GK",  r:89,pac:39,sho:15,pas:61,dri:16,def:90,phy:86,sm:1,wf:3,club:"Real Madrid",   nat:"🇧🇪",cat:"M"},
  {id:11, n:"Lamine Yamal",          s:"Yamal",       pos:"RM",  r:89,pac:91,sho:83,pas:84,dri:91,def:36,phy:66,sm:4,wf:3,club:"FC Barcelona",  nat:"🇪🇸",cat:"M"},
  {id:12, n:"Raphinha",              s:"Raphinha",    pos:"LM",  r:89,pac:88,sho:83,pas:79,dri:87,def:44,phy:69,sm:4,wf:4,club:"FC Barcelona",  nat:"🇧🇷",cat:"M"},
  {id:13, n:"Achraf Hakimi",         s:"Hakimi",      pos:"RB",  r:89,pac:96,sho:69,pas:79,dri:85,def:79,phy:74,sm:3,wf:3,club:"Paris SG",      nat:"🇲🇦",cat:"M"},
  {id:14, n:"Joshua Kimmich",        s:"Kimmich",     pos:"CDM", r:89,pac:71,sho:71,pas:89,dri:80,def:86,phy:76,sm:3,wf:3,club:"Bayern Munich", nat:"🇩🇪",cat:"M"},
  {id:15, n:"Alisson Becker",        s:"Alisson",     pos:"GK",  r:89,pac:37,sho:15,pas:63,dri:17,def:89,phy:79,sm:1,wf:3,club:"Liverpool",     nat:"🇧🇷",cat:"M"},
  {id:16, n:"Federico Valverde",     s:"Valverde",    pos:"CM",  r:89,pac:85,sho:81,pas:85,dri:83,def:79,phy:83,sm:3,wf:4,club:"Real Madrid",   nat:"🇺🇾",cat:"M"},
  {id:17, n:"Pedri",                 s:"Pedri",       pos:"CM",  r:89,pac:79,sho:75,pas:89,dri:91,def:73,phy:64,sm:4,wf:3,club:"FC Barcelona",  nat:"🇪🇸",cat:"M"},
  {id:18, n:"Florian Wirtz",         s:"Wirtz",       pos:"CAM", r:89,pac:80,sho:81,pas:86,dri:90,def:46,phy:68,sm:4,wf:4,club:"Liverpool",     nat:"🇩🇪",cat:"M"},
  {id:19, n:"Vitinha",               s:"Vitinha",     pos:"CM",  r:89,pac:74,sho:74,pas:87,dri:87,def:62,phy:68,sm:3,wf:3,club:"Paris SG",      nat:"🇵🇹",cat:"M"},
  {id:20, n:"Gianluigi Donnarumma",  s:"Donnarumma",  pos:"GK",  r:89,pac:44,sho:14,pas:62,dri:16,def:87,phy:84,sm:1,wf:3,club:"Man City",      nat:"🇮🇹",cat:"M"},
  {id:21, n:"Éderson",               s:"Éderson",     pos:"GK",  r:88,pac:46,sho:15,pas:73,dri:18,def:87,phy:81,sm:1,wf:3,club:"Man City",      nat:"🇧🇷",cat:"GK"},
  {id:22, n:"Emiliano Martínez",     s:"Emi Martínez",pos:"GK",  r:88,pac:39,sho:14,pas:59,dri:15,def:87,phy:83,sm:1,wf:3,club:"Aston Villa",   nat:"🇦🇷",cat:"GK"},
  {id:23, n:"Jan Oblak",             s:"Oblak",       pos:"GK",  r:87,pac:39,sho:14,pas:61,dri:15,def:87,phy:79,sm:1,wf:3,club:"Atlético",      nat:"🇸🇮",cat:"GK"},
  {id:24, n:"ter Stegen",            s:"ter Stegen",  pos:"GK",  r:87,pac:41,sho:14,pas:69,dri:16,def:86,phy:79,sm:1,wf:3,club:"FC Barcelona",  nat:"🇩🇪",cat:"GK"},
  {id:25, n:"Mike Maignan",          s:"Maignan",     pos:"GK",  r:87,pac:41,sho:14,pas:59,dri:15,def:86,phy:81,sm:1,wf:3,club:"AC Milan",      nat:"🇫🇷",cat:"GK"},
  {id:26, n:"Manuel Neuer",          s:"Neuer",       pos:"GK",  r:87,pac:53,sho:15,pas:72,dri:19,def:87,phy:82,sm:1,wf:3,club:"Bayern Munich", nat:"🇩🇪",cat:"GK"},
  {id:27, n:"Gregor Kobel",          s:"Kobel",       pos:"GK",  r:86,pac:39,sho:14,pas:58,dri:15,def:85,phy:79,sm:1,wf:3,club:"B. Dortmund",   nat:"🇨🇭",cat:"GK"},
  {id:28, n:"David Raya",            s:"D. Raya",     pos:"GK",  r:86,pac:40,sho:14,pas:60,dri:16,def:85,phy:78,sm:1,wf:3,club:"Arsenal",       nat:"🇪🇸",cat:"GK"},
  {id:29, n:"Yann Sommer",           s:"Sommer",      pos:"GK",  r:85,pac:39,sho:14,pas:58,dri:15,def:84,phy:73,sm:1,wf:3,club:"Inter Milan",   nat:"🇨🇭",cat:"GK"},
  {id:30, n:"André Onana",           s:"Onana",       pos:"GK",  r:85,pac:42,sho:13,pas:62,dri:16,def:83,phy:80,sm:1,wf:3,club:"Man United",    nat:"🇨🇲",cat:"GK"},
  {id:31, n:"Jordan Pickford",       s:"Pickford",    pos:"GK",  r:85,pac:41,sho:13,pas:56,dri:14,def:83,phy:75,sm:1,wf:3,club:"Everton",       nat:"🏴󠁧󠁢󠁥󠁮󠁧󠁿",cat:"GK"},
  {id:32, n:"Trent Alexander-Arnold",s:"T. Arnold",   pos:"RB",  r:88,pac:86,sho:71,pas:89,dri:80,def:79,phy:71,sm:3,wf:3,club:"Real Madrid",   nat:"🏴󠁧󠁢󠁥󠁮󠁧󠁿",cat:"DEF"},
  {id:33, n:"Reece James",           s:"R. James",    pos:"RB",  r:86,pac:83,sho:69,pas:78,dri:78,def:85,phy:81,sm:3,wf:3,club:"Chelsea",       nat:"🏴󠁧󠁢󠁥󠁮󠁧󠁿",cat:"DEF"},
  {id:34, n:"Dani Carvajal",         s:"Carvajal",    pos:"RB",  r:86,pac:81,sho:61,pas:81,dri:77,def:87,phy:79,sm:3,wf:3,club:"Real Madrid",   nat:"🇪🇸",cat:"DEF"},
  {id:35, n:"João Cancelo",          s:"Cancelo",     pos:"RB",  r:86,pac:84,sho:66,pas:82,dri:83,def:84,phy:73,sm:3,wf:3,club:"FC Barcelona",  nat:"🇵🇹",cat:"DEF"},
  {id:36, n:"Kyle Walker",           s:"K. Walker",   pos:"RB",  r:85,pac:92,sho:56,pas:73,dri:74,def:83,phy:79,sm:2,wf:3,club:"Man City",      nat:"🏴󠁧󠁢󠁥󠁮󠁧󠁿",cat:"DEF"},
  {id:37, n:"Pedro Porro",           s:"P. Porro",    pos:"RB",  r:84,pac:85,sho:64,pas:76,dri:78,def:80,phy:74,sm:3,wf:3,club:"Tottenham",     nat:"🇪🇸",cat:"DEF"},
  {id:38, n:"Ben White",             s:"B. White",    pos:"RB",  r:84,pac:79,sho:56,pas:73,dri:74,def:82,phy:76,sm:2,wf:3,club:"Arsenal",       nat:"🏴󠁧󠁢󠁥󠁮󠁧󠁿",cat:"DEF"},
  {id:39, n:"Denzel Dumfries",       s:"Dumfries",    pos:"RB",  r:84,pac:88,sho:66,pas:74,dri:77,def:79,phy:83,sm:3,wf:3,club:"Inter Milan",   nat:"🇳🇱",cat:"DEF"},
  {id:40, n:"Alphonso Davies",       s:"A. Davies",   pos:"LB",  r:88,pac:98,sho:62,pas:76,dri:85,def:82,phy:74,sm:3,wf:3,club:"Bayern Munich", nat:"🇨🇦",cat:"DEF"},
  {id:41, n:"Theo Hernandez",        s:"T. Hernandez",pos:"LB",  r:87,pac:92,sho:64,pas:76,dri:82,def:80,phy:82,sm:3,wf:3,club:"AC Milan",      nat:"🇫🇷",cat:"DEF"},
  {id:42, n:"Nuno Mendes",           s:"N. Mendes",   pos:"LB",  r:87,pac:95,sho:59,pas:75,dri:82,def:80,phy:76,sm:3,wf:3,club:"Paris SG",      nat:"🇵🇹",cat:"DEF"},
  {id:43, n:"Andrew Robertson",      s:"Robertson",   pos:"LB",  r:86,pac:87,sho:65,pas:83,dri:78,def:83,phy:80,sm:3,wf:3,club:"Liverpool",     nat:"🏴󠁧󠁢󠁳󠁣󠁴󠁿",cat:"DEF"},
  {id:44, n:"Josko Gvardiol",        s:"Gvardiol",    pos:"LB",  r:86,pac:84,sho:58,pas:71,dri:72,def:83,phy:82,sm:2,wf:3,club:"Man City",      nat:"🇭🇷",cat:"DEF"},
  {id:45, n:"Alejandro Grimaldo",    s:"Grimaldo",    pos:"LB",  r:85,pac:85,sho:70,pas:82,dri:81,def:80,phy:74,sm:3,wf:3,club:"Leverkusen",    nat:"🇪🇸",cat:"DEF"},
  {id:46, n:"Alejandro Balde",       s:"Balde",       pos:"LB",  r:85,pac:93,sho:57,pas:74,dri:81,def:79,phy:72,sm:3,wf:3,club:"FC Barcelona",  nat:"🇪🇸",cat:"DEF"},
  {id:47, n:"Oleks. Zinchenko",      s:"Zinchenko",   pos:"LB",  r:83,pac:76,sho:64,pas:80,dri:79,def:78,phy:66,sm:2,wf:3,club:"Arsenal",       nat:"🇺🇦",cat:"DEF"},
  {id:48, n:"Rúben Dias",            s:"R. Dias",     pos:"CB",  r:89,pac:74,sho:47,pas:70,dri:57,def:91,phy:89,sm:2,wf:3,club:"Man City",      nat:"🇵🇹",cat:"DEF"},
  {id:49, n:"Marquinhos",            s:"Marquinhos",  pos:"CB",  r:89,pac:75,sho:52,pas:74,dri:64,def:89,phy:84,sm:2,wf:3,club:"Paris SG",      nat:"🇧🇷",cat:"DEF"},
  {id:50, n:"Alessandro Bastoni",    s:"Bastoni",     pos:"CB",  r:89,pac:75,sho:50,pas:77,dri:67,def:88,phy:84,sm:2,wf:3,club:"Inter Milan",   nat:"🇮🇹",cat:"DEF"},
  {id:51, n:"Gabriel",               s:"Gabriel",     pos:"CB",  r:88,pac:74,sho:54,pas:66,dri:57,def:88,phy:90,sm:2,wf:3,club:"Arsenal",       nat:"🇧🇷",cat:"DEF"},
  {id:52, n:"William Saliba",        s:"Saliba",      pos:"CB",  r:88,pac:80,sho:46,pas:69,dri:59,def:88,phy:87,sm:2,wf:3,club:"Arsenal",       nat:"🇫🇷",cat:"DEF"},
  {id:53, n:"Pau Cubarsí",           s:"Cubarsí",     pos:"CB",  r:87,pac:74,sho:44,pas:72,dri:64,def:87,phy:82,sm:2,wf:3,club:"FC Barcelona",  nat:"🇪🇸",cat:"DEF"},
  {id:54, n:"Antonio Rüdiger",       s:"Rüdiger",     pos:"CB",  r:87,pac:82,sho:57,pas:67,dri:60,def:87,phy:90,sm:2,wf:3,club:"Real Madrid",   nat:"🇩🇪",cat:"DEF"},
  {id:55, n:"Jonathan Tah",          s:"Tah",         pos:"CB",  r:87,pac:82,sho:50,pas:67,dri:57,def:88,phy:87,sm:2,wf:3,club:"Bayern Munich", nat:"🇩🇪",cat:"DEF"},
  {id:56, n:"Kim Min-jae",           s:"Kim Min-jae", pos:"CB",  r:86,pac:82,sho:46,pas:66,dri:59,def:87,phy:88,sm:2,wf:3,club:"Bayern Munich", nat:"🇰🇷",cat:"DEF"},
  {id:57, n:"Dayot Upamecano",       s:"Upamecano",   pos:"CB",  r:86,pac:84,sho:45,pas:64,dri:57,def:85,phy:87,sm:2,wf:3,club:"Bayern Munich", nat:"🇫🇷",cat:"DEF"},
  {id:58, n:"Gleison Bremer",        s:"Bremer",      pos:"CB",  r:85,pac:80,sho:46,pas:65,dri:57,def:87,phy:87,sm:2,wf:3,club:"Juventus",      nat:"🇧🇷",cat:"DEF"},
  {id:59, n:"Micky van de Ven",      s:"Van de Ven",  pos:"CB",  r:85,pac:90,sho:41,pas:64,dri:58,def:84,phy:84,sm:2,wf:3,club:"Tottenham",     nat:"🇳🇱",cat:"DEF"},
  {id:60, n:"Pau Torres",            s:"P. Torres",   pos:"CB",  r:85,pac:72,sho:50,pas:72,dri:60,def:86,phy:82,sm:2,wf:3,club:"Aston Villa",   nat:"🇪🇸",cat:"DEF"},
  {id:61, n:"Fikayo Tomori",         s:"Tomori",      pos:"CB",  r:85,pac:84,sho:44,pas:62,dri:57,def:85,phy:84,sm:2,wf:3,club:"AC Milan",      nat:"🏴󠁧󠁢󠁥󠁮󠁧󠁿",cat:"DEF"},
  {id:62, n:"John Stones",           s:"J. Stones",   pos:"CB",  r:84,pac:75,sho:52,pas:75,dri:68,def:85,phy:80,sm:2,wf:3,club:"Man City",      nat:"🏴󠁧󠁢󠁥󠁮󠁧󠁿",cat:"DEF"},
  {id:63, n:"Kevin De Bruyne",       s:"De Bruyne",   pos:"CDM", r:88,pac:76,sho:86,pas:92,dri:88,def:64,phy:78,sm:4,wf:5,club:"Man City",      nat:"🇧🇪",cat:"MID"},
  {id:64, n:"Declan Rice",           s:"D. Rice",     pos:"CDM", r:87,pac:75,sho:73,pas:81,dri:76,def:88,phy:84,sm:2,wf:3,club:"Arsenal",       nat:"🏴󠁧󠁢󠁥󠁮󠁧󠁿",cat:"MID"},
  {id:65, n:"Aurélien Tchouaméni",   s:"Tchouaméni",  pos:"CDM", r:87,pac:74,sho:71,pas:81,dri:79,def:87,phy:85,sm:3,wf:4,club:"Real Madrid",   nat:"🇫🇷",cat:"MID"},
  {id:66, n:"Hakan Çalhanoğlu",      s:"Çalhanoğlu",  pos:"CDM", r:87,pac:69,sho:79,pas:88,dri:83,def:79,phy:74,sm:3,wf:4,club:"Inter Milan",   nat:"🇹🇷",cat:"MID"},
  {id:67, n:"Moisés Caicedo",        s:"Caicedo",     pos:"CDM", r:86,pac:75,sho:65,pas:79,dri:78,def:85,phy:83,sm:3,wf:3,club:"Chelsea",       nat:"🇪🇨",cat:"MID"},
  {id:68, n:"Granit Xhaka",          s:"Xhaka",       pos:"CDM", r:85,pac:65,sho:71,pas:85,dri:75,def:83,phy:79,sm:2,wf:4,club:"Leverkusen",    nat:"🇨🇭",cat:"MID"},
  {id:69, n:"Thomas Partey",         s:"Partey",      pos:"CDM", r:85,pac:74,sho:70,pas:80,dri:76,def:85,phy:84,sm:3,wf:3,club:"Arsenal",       nat:"🇬🇭",cat:"MID"},
  {id:70, n:"Martin Zubimendi",      s:"Zubimendi",   pos:"CDM", r:85,pac:67,sho:68,pas:84,dri:78,def:85,phy:76,sm:3,wf:3,club:"Arsenal",       nat:"🇪🇸",cat:"MID"},
  {id:71, n:"João Neves",            s:"J. Neves",    pos:"CDM", r:84,pac:76,sho:68,pas:82,dri:80,def:82,phy:74,sm:3,wf:3,club:"Paris SG",      nat:"🇵🇹",cat:"MID"},
  {id:72, n:"Sandro Tonali",         s:"Tonali",      pos:"CDM", r:84,pac:69,sho:72,pas:82,dri:79,def:83,phy:80,sm:3,wf:3,club:"Newcastle",      nat:"🇮🇹",cat:"MID"},
  {id:73, n:"Nicolò Barella",        s:"Barella",     pos:"CM",  r:88,pac:74,sho:76,pas:87,dri:85,def:82,phy:80,sm:3,wf:4,club:"Inter Milan",   nat:"🇮🇹",cat:"MID"},
  {id:74, n:"Bernardo Silva",        s:"B. Silva",    pos:"CM",  r:88,pac:82,sho:81,pas:89,dri:89,def:70,phy:69,sm:4,wf:4,club:"Man City",      nat:"🇵🇹",cat:"MID"},
  {id:75, n:"Luka Modrić",           s:"Modrić",      pos:"CM",  r:87,pac:74,sho:78,pas:92,dri:90,def:74,phy:68,sm:4,wf:4,club:"Real Madrid",   nat:"🇭🇷",cat:"MID"},
  {id:76, n:"Eduardo Camavinga",     s:"Camavinga",   pos:"CM",  r:87,pac:82,sho:70,pas:82,dri:84,def:80,phy:78,sm:4,wf:3,club:"Real Madrid",   nat:"🇫🇷",cat:"MID"},
  {id:77, n:"Bruno Fernandes",       s:"B. Fernandes",pos:"CM",  r:87,pac:73,sho:83,pas:89,dri:84,def:63,phy:73,sm:4,wf:3,club:"Man United",    nat:"🇵🇹",cat:"MID"},
  {id:78, n:"Gavi",                  s:"Gavi",        pos:"CM",  r:86,pac:77,sho:71,pas:86,dri:88,def:79,phy:66,sm:4,wf:3,club:"FC Barcelona",  nat:"🇪🇸",cat:"MID"},
  {id:79, n:"Fabian Ruiz",           s:"F. Ruiz",     pos:"CM",  r:85,pac:68,sho:76,pas:87,dri:82,def:66,phy:72,sm:3,wf:3,club:"Paris SG",      nat:"🇪🇸",cat:"MID"},
  {id:80, n:"Dominik Szoboszlai",    s:"Szoboszlai",  pos:"CM",  r:85,pac:81,sho:79,pas:83,dri:84,def:66,phy:79,sm:3,wf:4,club:"Liverpool",     nat:"🇭🇺",cat:"MID"},
  {id:81, n:"Enzo Fernández",        s:"E. Fernández",pos:"CM",  r:85,pac:73,sho:73,pas:84,dri:83,def:77,phy:75,sm:3,wf:4,club:"Chelsea",       nat:"🇦🇷",cat:"MID"},
  {id:82, n:"Ryan Gravenberch",      s:"Gravenberch", pos:"CM",  r:85,pac:79,sho:67,pas:82,dri:82,def:74,phy:80,sm:3,wf:3,club:"Liverpool",     nat:"🇳🇱",cat:"MID"},
  {id:83, n:"Alexis Mac Allister",   s:"Mac Allister",pos:"CM",  r:85,pac:74,sho:75,pas:84,dri:80,def:74,phy:77,sm:3,wf:4,club:"Liverpool",     nat:"🇦🇷",cat:"MID"},
  {id:84, n:"Tijjani Reijnders",     s:"Reijnders",   pos:"CM",  r:85,pac:76,sho:74,pas:83,dri:83,def:73,phy:75,sm:3,wf:4,club:"AC Milan",      nat:"🇳🇱",cat:"MID"},
  {id:85, n:"Warren Zaïre-Emery",    s:"Zaïre-Emery", pos:"CM",  r:85,pac:81,sho:72,pas:82,dri:83,def:74,phy:75,sm:3,wf:3,club:"Paris SG",      nat:"🇫🇷",cat:"MID"},
  {id:86, n:"Douglas Luiz",          s:"D. Luiz",     pos:"CM",  r:84,pac:74,sho:72,pas:80,dri:79,def:76,phy:79,sm:3,wf:3,club:"Juventus",      nat:"🇧🇷",cat:"MID"},
  {id:87, n:"Jamal Musiala",         s:"Musiala",     pos:"CAM", r:88,pac:83,sho:81,pas:84,dri:91,def:49,phy:70,sm:4,wf:3,club:"Bayern Munich", nat:"🇩🇪",cat:"MID"},
  {id:88, n:"Cole Palmer",           s:"C. Palmer",   pos:"CAM", r:88,pac:78,sho:84,pas:86,dri:88,def:52,phy:70,sm:4,wf:4,club:"Chelsea",       nat:"🏴󠁧󠁢󠁥󠁮󠁧󠁿",cat:"MID"},
  {id:89, n:"Martin Ødegaard",       s:"Ødegaard",    pos:"CAM", r:88,pac:76,sho:80,pas:90,dri:89,def:61,phy:66,sm:4,wf:4,club:"Arsenal",       nat:"🇳🇴",cat:"MID"},
  {id:90, n:"Phil Foden",            s:"Foden",       pos:"CAM", r:88,pac:84,sho:84,pas:85,dri:89,def:56,phy:71,sm:4,wf:3,club:"Man City",      nat:"🏴󠁧󠁢󠁥󠁮󠁧󠁿",cat:"MID"},
  {id:91, n:"Antoine Griezmann",     s:"Griezmann",   pos:"CAM", r:87,pac:79,sho:88,pas:83,dri:85,def:59,phy:75,sm:4,wf:4,club:"Atlético",      nat:"🇫🇷",cat:"MID"},
  {id:92, n:"Dani Olmo",             s:"D. Olmo",     pos:"CAM", r:87,pac:83,sho:80,pas:84,dri:87,def:54,phy:72,sm:3,wf:3,club:"FC Barcelona",  nat:"🇪🇸",cat:"MID"},
  {id:93, n:"Christopher Nkunku",    s:"Nkunku",      pos:"CAM", r:87,pac:84,sho:84,pas:80,dri:88,def:42,phy:72,sm:4,wf:3,club:"Chelsea",       nat:"🇫🇷",cat:"MID"},
  {id:94, n:"Xavi Simons",           s:"X. Simons",   pos:"CAM", r:86,pac:84,sho:78,pas:84,dri:89,def:50,phy:64,sm:4,wf:3,club:"RB Leipzig",    nat:"🇳🇱",cat:"MID"},
  {id:95, n:"Eberechi Eze",          s:"E. Eze",      pos:"CAM", r:84,pac:80,sho:80,pas:80,dri:85,def:46,phy:68,sm:4,wf:3,club:"Crystal Palace",nat:"🏴󠁧󠁢󠁥󠁮󠁧󠁿",cat:"MID"},
  {id:96, n:"Leroy Sané",            s:"Sané",        pos:"LM",  r:86,pac:94,sho:81,pas:77,dri:88,def:36,phy:73,sm:4,wf:3,club:"Bayern Munich", nat:"🇩🇪",cat:"MID"},
  {id:97, n:"Gabriel Martinelli",    s:"Martinelli",  pos:"LM",  r:85,pac:91,sho:81,pas:74,dri:84,def:46,phy:73,sm:3,wf:4,club:"Arsenal",       nat:"🇧🇷",cat:"MID"},
  {id:98, n:"Kaoru Mitoma",          s:"Mitoma",      pos:"LM",  r:85,pac:94,sho:79,pas:74,dri:88,def:41,phy:69,sm:4,wf:3,club:"Brighton",      nat:"🇯🇵",cat:"MID"},
  {id:99, n:"Pedro Neto",            s:"P. Neto",     pos:"RM",  r:85,pac:92,sho:76,pas:74,dri:86,def:40,phy:64,sm:4,wf:3,club:"Chelsea",       nat:"🇵🇹",cat:"MID"},
  {id:100,n:"Bryan Mbeumo",          s:"Mbeumo",      pos:"RM",  r:84,pac:88,sho:80,pas:74,dri:83,def:40,phy:70,sm:3,wf:3,club:"Brentford",     nat:"🇨🇲",cat:"MID"},
  {id:101,n:"Son Heung-min",         s:"Son",         pos:"LW",  r:88,pac:89,sho:87,pas:81,dri:86,def:47,phy:71,sm:4,wf:4,club:"Tottenham",     nat:"🇰🇷",cat:"FWD"},
  {id:102,n:"K. Kvaratskhelia",      s:"Kvara",       pos:"LW",  r:88,pac:91,sho:84,pas:81,dri:92,def:39,phy:73,sm:5,wf:3,club:"Paris SG",      nat:"🇬🇪",cat:"FWD"},
  {id:103,n:"Nico Williams",         s:"N. Williams", pos:"LW",  r:87,pac:95,sho:79,pas:78,dri:89,def:34,phy:68,sm:4,wf:3,club:"Athletic Club", nat:"🇪🇸",cat:"FWD"},
  {id:104,n:"Rafael Leão",           s:"Leão",        pos:"LW",  r:87,pac:94,sho:81,pas:75,dri:89,def:34,phy:74,sm:4,wf:3,club:"AC Milan",      nat:"🇵🇹",cat:"FWD"},
  {id:105,n:"Michael Olise",         s:"Olise",       pos:"LW",  r:86,pac:85,sho:81,pas:79,dri:87,def:42,phy:67,sm:4,wf:3,club:"Bayern Munich", nat:"🏴󠁧󠁢󠁥󠁮󠁧󠁿",cat:"FWD"},
  {id:106,n:"Cody Gakpo",            s:"Gakpo",       pos:"LW",  r:85,pac:87,sho:82,pas:75,dri:83,def:44,phy:75,sm:3,wf:3,club:"Liverpool",     nat:"🇳🇱",cat:"FWD"},
  {id:107,n:"Jamie Gittens",         s:"Gittens",     pos:"LW",  r:85,pac:93,sho:76,pas:72,dri:86,def:35,phy:64,sm:4,wf:3,club:"B. Dortmund",   nat:"🏴󠁧󠁢󠁥󠁮󠁧󠁿",cat:"FWD"},
  {id:108,n:"Marcus Rashford",       s:"Rashford",    pos:"LW",  r:84,pac:92,sho:80,pas:73,dri:84,def:43,phy:74,sm:4,wf:3,club:"Marseille",     nat:"🏴󠁧󠁢󠁥󠁮󠁧󠁿",cat:"FWD"},
  {id:109,n:"Alejandro Garnacho",    s:"Garnacho",    pos:"LW",  r:84,pac:88,sho:76,pas:71,dri:84,def:38,phy:66,sm:4,wf:3,club:"Man United",    nat:"🇦🇷",cat:"FWD"},
  {id:110,n:"Moussa Diaby",          s:"Diaby",       pos:"LW",  r:84,pac:94,sho:78,pas:74,dri:86,def:34,phy:70,sm:4,wf:3,club:"Aston Villa",   nat:"🇫🇷",cat:"FWD"},
  {id:111,n:"Bukayo Saka",           s:"Saka",        pos:"RW",  r:88,pac:87,sho:82,pas:82,dri:87,def:60,phy:72,sm:4,wf:4,club:"Arsenal",       nat:"🏴󠁧󠁢󠁥󠁮󠁧󠁿",cat:"FWD"},
  {id:112,n:"Rodrygo",               s:"Rodrygo",     pos:"RW",  r:87,pac:88,sho:82,pas:80,dri:88,def:45,phy:67,sm:4,wf:4,club:"Real Madrid",   nat:"🇧🇷",cat:"FWD"},
  {id:113,n:"Kingsley Coman",        s:"Coman",       pos:"RW",  r:85,pac:92,sho:78,pas:76,dri:87,def:37,phy:70,sm:4,wf:4,club:"Bayern Munich", nat:"🇫🇷",cat:"FWD"},
  {id:114,n:"Jarrod Bowen",          s:"Bowen",       pos:"RW",  r:84,pac:86,sho:79,pas:74,dri:82,def:44,phy:72,sm:3,wf:3,club:"West Ham",      nat:"🏴󠁧󠁢󠁥󠁮󠁧󠁿",cat:"FWD"},
  {id:115,n:"Mohamed Kudus",         s:"Kudus",       pos:"RW",  r:84,pac:87,sho:78,pas:72,dri:85,def:42,phy:72,sm:4,wf:3,club:"West Ham",      nat:"🇬🇭",cat:"FWD"},
  {id:116,n:"Karim Adeyemi",         s:"Adeyemi",     pos:"RW",  r:84,pac:96,sho:76,pas:69,dri:82,def:34,phy:68,sm:4,wf:3,club:"B. Dortmund",   nat:"🇩🇪",cat:"FWD"},
  {id:117,n:"Donyell Malen",         s:"Malen",       pos:"RW",  r:84,pac:92,sho:78,pas:72,dri:83,def:35,phy:68,sm:4,wf:3,club:"Aston Villa",   nat:"🇳🇱",cat:"FWD"},
  {id:118,n:"Ferran Torres",         s:"F. Torres",   pos:"RW",  r:83,pac:87,sho:79,pas:74,dri:82,def:42,phy:68,sm:3,wf:3,club:"FC Barcelona",  nat:"🇪🇸",cat:"FWD"},
  {id:119,n:"Robert Lewandowski",    s:"Lewandowski", pos:"ST",  r:88,pac:72,sho:89,pas:79,dri:80,def:44,phy:79,sm:3,wf:4,club:"FC Barcelona",  nat:"🇵🇱",cat:"FWD"},
  {id:120,n:"Alexander Isak",        s:"A. Isak",     pos:"ST",  r:88,pac:87,sho:89,pas:72,dri:84,def:44,phy:75,sm:3,wf:3,club:"Liverpool",     nat:"🇸🇪",cat:"FWD"},
  {id:121,n:"Lautaro Martínez",      s:"Lautaro",     pos:"ST",  r:88,pac:79,sho:88,pas:72,dri:85,def:44,phy:84,sm:3,wf:4,club:"Inter Milan",   nat:"🇦🇷",cat:"FWD"},
  {id:122,n:"Viktor Gyökeres",       s:"Gyökeres",    pos:"ST",  r:87,pac:82,sho:87,pas:68,dri:79,def:44,phy:91,sm:3,wf:3,club:"Arsenal",       nat:"🇸🇪",cat:"FWD"},
  {id:123,n:"Julián Álvarez",        s:"J. Álvarez",  pos:"ST",  r:87,pac:82,sho:86,pas:74,dri:85,def:50,phy:76,sm:4,wf:3,club:"Atlético",      nat:"🇦🇷",cat:"FWD"},
  {id:124,n:"Ollie Watkins",         s:"Watkins",     pos:"ST",  r:87,pac:91,sho:86,pas:70,dri:81,def:45,phy:78,sm:3,wf:3,club:"Aston Villa",   nat:"🏴󠁧󠁢󠁥󠁮󠁧󠁿",cat:"FWD"},
  {id:125,n:"Dušan Vlahović",        s:"Vlahović",    pos:"ST",  r:87,pac:77,sho:90,pas:61,dri:75,def:39,phy:84,sm:3,wf:4,club:"Juventus",      nat:"🇷🇸",cat:"FWD"},
  {id:126,n:"Darwin Núñez",          s:"Núñez",       pos:"ST",  r:86,pac:95,sho:84,pas:64,dri:82,def:42,phy:84,sm:3,wf:3,club:"Liverpool",     nat:"🇺🇾",cat:"FWD"},
  {id:127,n:"Lois Openda",           s:"Openda",      pos:"ST",  r:86,pac:93,sho:83,pas:65,dri:81,def:39,phy:75,sm:3,wf:3,club:"RB Leipzig",    nat:"🇧🇪",cat:"FWD"},
  {id:128,n:"Serhou Guirassy",       s:"Guirassy",    pos:"ST",  r:86,pac:84,sho:88,pas:59,dri:75,def:39,phy:83,sm:3,wf:4,club:"B. Dortmund",   nat:"🇬🇳",cat:"FWD"},
  {id:129,n:"Marcus Thuram",         s:"Thuram",      pos:"ST",  r:85,pac:89,sho:82,pas:68,dri:79,def:43,phy:84,sm:3,wf:4,club:"Inter Milan",   nat:"🇫🇷",cat:"FWD"},
  {id:130,n:"Gonçalo Ramos",         s:"G. Ramos",    pos:"ST",  r:85,pac:76,sho:84,pas:66,dri:76,def:38,phy:77,sm:3,wf:4,club:"Paris SG",      nat:"🇵🇹",cat:"FWD"},
  {id:131,n:"Artem Dovbyk",          s:"Dovbyk",      pos:"ST",  r:85,pac:74,sho:87,pas:62,dri:72,def:38,phy:82,sm:2,wf:3,club:"Roma",           nat:"🇺🇦",cat:"FWD"},
  {id:132,n:"Randal Kolo Muani",     s:"Kolo Muani",  pos:"ST",  r:85,pac:91,sho:80,pas:72,dri:79,def:40,phy:74,sm:3,wf:3,club:"Juventus",      nat:"🇫🇷",cat:"FWD"},
  {id:133,n:"Matheus Cunha",         s:"Cunha",       pos:"ST",  r:85,pac:84,sho:80,pas:72,dri:83,def:44,phy:72,sm:4,wf:3,club:"Wolves",         nat:"🇧🇷",cat:"FWD"},
  {id:134,n:"Nicolas Jackson",       s:"Jackson",     pos:"ST",  r:84,pac:89,sho:80,pas:63,dri:79,def:39,phy:75,sm:3,wf:3,club:"Chelsea",       nat:"🇸🇳",cat:"FWD"},
  {id:135,n:"Rasmus Højlund",        s:"Højlund",     pos:"ST",  r:84,pac:89,sho:82,pas:62,dri:78,def:40,phy:78,sm:3,wf:3,club:"Man United",    nat:"🇩🇰",cat:"FWD"},
  {id:136,n:"Benjamin Šeško",        s:"Šeško",       pos:"ST",  r:84,pac:85,sho:82,pas:59,dri:75,def:36,phy:81,sm:3,wf:3,club:"RB Leipzig",    nat:"🇸🇮",cat:"FWD"},
  {id:137,n:"Marcus Thuram (B)",     s:"Thuram B",    pos:"ST",  r:85,pac:89,sho:82,pas:68,dri:79,def:43,phy:84,sm:3,wf:4,club:"Inter Milan",   nat:"🇫🇷",cat:"FWD"},
  {id:138,n:"Jhon Durán",            s:"J. Durán",    pos:"ST",  r:83,pac:82,sho:82,pas:58,dri:74,def:36,phy:80,sm:3,wf:3,club:"Aston Villa",   nat:"🇨🇴",cat:"FWD"},
  {id:139,n:"Ivan Toney",            s:"Toney",       pos:"ST",  r:83,pac:75,sho:83,pas:68,dri:74,def:40,phy:82,sm:2,wf:3,club:"Al-Ahli",       nat:"🏴󠁧󠁢󠁥󠁮󠁧󠁿",cat:"FWD"},
  {id:140,n:"Evan Ferguson",         s:"Ferguson",    pos:"ST",  r:83,pac:74,sho:83,pas:62,dri:74,def:36,phy:78,sm:2,wf:3,club:"Brighton",      nat:"🇮🇪",cat:"FWD"},
  {id:141,n:"Diogo Dalot",           s:"D. Dalot",    pos:"RB",  r:83,pac:83,sho:58,pas:74,dri:76,def:80,phy:74,sm:3,wf:3,club:"Man United",    nat:"🇵🇹",cat:"DEF"},
  {id:142,n:"Malo Gusto",            s:"M. Gusto",    pos:"RB",  r:83,pac:87,sho:56,pas:72,dri:76,def:79,phy:72,sm:2,wf:3,club:"Chelsea",       nat:"🇫🇷",cat:"DEF"},
  {id:143,n:"Ferdi Kadioglu",        s:"Kadioglu",    pos:"LB",  r:84,pac:83,sho:57,pas:72,dri:78,def:78,phy:70,sm:3,wf:3,club:"Fenerbahce",    nat:"🇹🇷",cat:"DEF"},
  {id:144,n:"Stefan de Vrij",        s:"De Vrij",     pos:"CB",  r:83,pac:68,sho:47,pas:68,dri:58,def:84,phy:80,sm:2,wf:3,club:"Inter Milan",   nat:"🇳🇱",cat:"DEF"},
  {id:145,n:"Evan Ndicka",           s:"Ndicka",      pos:"CB",  r:84,pac:80,sho:44,pas:66,dri:58,def:84,phy:84,sm:2,wf:3,club:"Roma",           nat:"🇫🇷",cat:"DEF"},
  {id:146,n:"Kalidou Koulibaly",     s:"Koulibaly",   pos:"CB",  r:84,pac:80,sho:52,pas:66,dri:62,def:87,phy:88,sm:2,wf:3,club:"Al-Hilal",      nat:"🇸🇳",cat:"DEF"},
  {id:147,n:"Edmond Tapsoba",        s:"Tapsoba",     pos:"CB",  r:83,pac:79,sho:44,pas:62,dri:57,def:83,phy:84,sm:2,wf:3,club:"Leverkusen",    nat:"🇧🇫",cat:"DEF"},
  {id:148,n:"Milan Škriniar",        s:"Škriniar",    pos:"CB",  r:84,pac:73,sho:46,pas:65,dri:58,def:85,phy:84,sm:2,wf:3,club:"Paris SG",      nat:"🇸🇰",cat:"DEF"},
  {id:149,n:"Exequiel Palacios",     s:"Palacios",    pos:"CDM", r:84,pac:72,sho:70,pas:82,dri:80,def:81,phy:78,sm:3,wf:3,club:"Leverkusen",    nat:"🇦🇷",cat:"MID"},
  {id:150,n:"Youssouf Fofana",       s:"Fofana",      pos:"CDM", r:83,pac:78,sho:64,pas:76,dri:74,def:82,phy:80,sm:3,wf:3,club:"AC Milan",      nat:"🇫🇷",cat:"MID"},
  {id:151,n:"Davide Frattesi",       s:"Frattesi",    pos:"CM",  r:84,pac:79,sho:75,pas:78,dri:80,def:73,phy:80,sm:3,wf:3,club:"Inter Milan",   nat:"🇮🇹",cat:"MID"},
  {id:152,n:"Orkun Kökcü",           s:"Kökcü",       pos:"CAM", r:83,pac:72,sho:74,pas:82,dri:82,def:52,phy:68,sm:3,wf:3,club:"Benfica",       nat:"🇹🇷",cat:"MID"},
  {id:153,n:"Harvey Elliott",        s:"H. Elliott",  pos:"RM",  r:83,pac:82,sho:74,pas:80,dri:84,def:52,phy:65,sm:3,wf:3,club:"Liverpool",     nat:"🏴󠁧󠁢󠁥󠁮󠁧󠁿",cat:"MID"},
  {id:154,n:"Takefusa Kubo",         s:"Kubo",        pos:"RM",  r:84,pac:83,sho:75,pas:76,dri:87,def:42,phy:62,sm:4,wf:3,club:"Real Sociedad", nat:"🇯🇵",cat:"MID"},
  {id:155,n:"Noni Madueke",          s:"Madueke",     pos:"RM",  r:84,pac:90,sho:78,pas:72,dri:85,def:37,phy:69,sm:4,wf:3,club:"Chelsea",       nat:"🏴󠁧󠁢󠁥󠁮󠁧󠁿",cat:"MID"},
  {id:156,n:"Jacob Ramsey",          s:"J. Ramsey",   pos:"CM",  r:83,pac:79,sho:72,pas:74,dri:79,def:66,phy:76,sm:3,wf:3,club:"Aston Villa",   nat:"🏴󠁧󠁢󠁥󠁮󠁧󠁿",cat:"MID"},
  {id:157,n:"Youri Tielemans",       s:"Tielemans",   pos:"CM",  r:84,pac:72,sho:76,pas:84,dri:80,def:70,phy:74,sm:3,wf:4,club:"Aston Villa",   nat:"🇧🇪",cat:"MID"},
  {id:158,n:"Matteo Guendouzi",      s:"Guendouzi",   pos:"CM",  r:83,pac:78,sho:65,pas:82,dri:79,def:75,phy:79,sm:3,wf:3,club:"Lazio",          nat:"🇫🇷",cat:"MID"},
  {id:159,n:"Ilkay Gündoğan",        s:"Gündoğan",    pos:"CAM", r:84,pac:64,sho:78,pas:87,dri:82,def:67,phy:69,sm:3,wf:4,club:"FC Barcelona",  nat:"🇩🇪",cat:"MID"},
  {id:160,n:"James Maddison",        s:"Maddison",    pos:"CAM", r:84,pac:74,sho:80,pas:84,dri:83,def:46,phy:67,sm:3,wf:3,club:"Tottenham",     nat:"🏴󠁧󠁢󠁥󠁮󠁧󠁿",cat:"MID"},
  {id:161,n:"Serge Gnabry",          s:"Gnabry",      pos:"LW",  r:83,pac:87,sho:78,pas:74,dri:82,def:38,phy:68,sm:4,wf:3,club:"Bayern Munich", nat:"🇩🇪",cat:"FWD"},
  {id:162,n:"Leon Bailey",           s:"Bailey",      pos:"LW",  r:83,pac:92,sho:78,pas:73,dri:86,def:36,phy:69,sm:4,wf:3,club:"Aston Villa",   nat:"🇯🇲",cat:"FWD"},
  {id:163,n:"Mattia Zaccagni",       s:"Zaccagni",    pos:"LW",  r:83,pac:84,sho:76,pas:74,dri:83,def:40,phy:68,sm:3,wf:3,club:"Lazio",          nat:"🇮🇹",cat:"FWD"},
  {id:164,n:"Ansu Fati",             s:"Ansu Fati",   pos:"LW",  r:83,pac:87,sho:78,pas:72,dri:83,def:37,phy:64,sm:4,wf:3,club:"FC Barcelona",  nat:"🇪🇸",cat:"FWD"},
  {id:165,n:"Samuel Chukwueze",      s:"Chukwueze",   pos:"RW",  r:83,pac:90,sho:76,pas:68,dri:83,def:37,phy:67,sm:4,wf:3,club:"AC Milan",      nat:"🇳🇬",cat:"FWD"},
  {id:166,n:"Richarlison",           s:"Richarlison", pos:"ST",  r:83,pac:86,sho:80,pas:65,dri:78,def:44,phy:78,sm:3,wf:3,club:"Tottenham",     nat:"🇧🇷",cat:"FWD"},
  {id:167,n:"Dominic Solanke",       s:"Solanke",     pos:"ST",  r:83,pac:78,sho:80,pas:68,dri:74,def:42,phy:76,sm:2,wf:3,club:"Tottenham",     nat:"🏴󠁧󠁢󠁥󠁮󠁧󠁿",cat:"FWD"},
  {id:168,n:"Giacomo Raspadori",     s:"Raspadori",   pos:"ST",  r:83,pac:78,sho:82,pas:74,dri:80,def:47,phy:68,sm:3,wf:4,club:"Napoli",         nat:"🇮🇹",cat:"FWD"},
  {id:169,n:"Joao Pedro",            s:"João Pedro",  pos:"ST",  r:83,pac:76,sho:79,pas:68,dri:77,def:40,phy:75,sm:3,wf:3,club:"Brighton",      nat:"🇧🇷",cat:"FWD"},
  {id:170,n:"Sofyan Amrabat",        s:"Amrabat",     pos:"CDM", r:83,pac:74,sho:62,pas:78,dri:73,def:82,phy:80,sm:2,wf:3,club:"Man United",    nat:"🇲🇦",cat:"MID"},
  {id:171,n:"Weston McKennie",       s:"McKennie",    pos:"CM",  r:83,pac:79,sho:72,pas:75,dri:76,def:73,phy:80,sm:3,wf:3,club:"Juventus",      nat:"🇺🇸",cat:"MID"},
  {id:172,n:"Tomas Soucek",          s:"Soucek",      pos:"CM",  r:83,pac:69,sho:72,pas:74,dri:68,def:75,phy:84,sm:2,wf:3,club:"West Ham",      nat:"🇨🇿",cat:"MID"},
  {id:173,n:"Leandro Paredes",       s:"Paredes",     pos:"CDM", r:83,pac:64,sho:68,pas:85,dri:76,def:70,phy:72,sm:3,wf:3,club:"Roma",           nat:"🇦🇷",cat:"MID"},
  {id:174,n:"Emerson Royal",         s:"E. Royal",    pos:"RB",  r:82,pac:83,sho:56,pas:70,dri:73,def:79,phy:76,sm:2,wf:3,club:"AC Milan",      nat:"🇧🇷",cat:"DEF"},
  {id:175,n:"Lucas Hernandez",       s:"L. Hernandez",pos:"LB",  r:83,pac:76,sho:49,pas:66,dri:66,def:84,phy:81,sm:2,wf:3,club:"Paris SG",      nat:"🇫🇷",cat:"DEF"},
  {id:176,n:"Caglar Söyüncü",        s:"Söyüncü",     pos:"CB",  r:83,pac:72,sho:42,pas:62,dri:55,def:83,phy:82,sm:2,wf:3,club:"Atlético",      nat:"🇹🇷",cat:"DEF"},
  {id:177,n:"Maxence Lacroix",       s:"Lacroix",     pos:"CB",  r:82,pac:78,sho:42,pas:60,dri:55,def:82,phy:82,sm:2,wf:3,club:"Chelsea",       nat:"🇫🇷",cat:"DEF"},
  {id:178,n:"Danilo",                s:"Danilo",      pos:"CB",  r:84,pac:74,sho:46,pas:70,dri:62,def:84,phy:80,sm:2,wf:3,club:"Juventus",      nat:"🇧🇷",cat:"DEF"},
  {id:179,n:"Konstantinos Mavropanos",s:"Mavropanos", pos:"CB",  r:82,pac:75,sho:42,pas:60,dri:52,def:82,phy:84,sm:2,wf:3,club:"West Ham",      nat:"🇬🇷",cat:"DEF"},
  {id:180,n:"Lewis Dunk",            s:"L. Dunk",     pos:"CB",  r:82,pac:69,sho:43,pas:64,dri:52,def:83,phy:82,sm:2,wf:3,club:"Brighton",      nat:"🏴󠁧󠁢󠁥󠁮󠁧󠁿",cat:"DEF"},
  {id:181,n:"Andreas Pereira",       s:"A. Pereira",  pos:"CAM", r:82,pac:74,sho:74,pas:80,dri:79,def:52,phy:68,sm:3,wf:3,club:"Fulham",         nat:"🇧🇷",cat:"MID"},
  {id:182,n:"Said Benrahma",         s:"Benrahma",    pos:"LM",  r:82,pac:82,sho:74,pas:74,dri:85,def:37,phy:64,sm:4,wf:3,club:"Lyon",           nat:"🇩🇿",cat:"MID"},
  {id:183,n:"Timo Werner",           s:"T. Werner",   pos:"LW",  r:82,pac:91,sho:78,pas:72,dri:79,def:38,phy:68,sm:3,wf:3,club:"Tottenham",     nat:"🇩🇪",cat:"FWD"},
  {id:184,n:"Yannick Carrasco",      s:"Carrasco",    pos:"LW",  r:83,pac:87,sho:76,pas:74,dri:84,def:42,phy:67,sm:4,wf:3,club:"Al-Qadsiah",    nat:"🇧🇪",cat:"FWD"},
  {id:185,n:"Tammy Abraham",         s:"T. Abraham",  pos:"ST",  r:82,pac:82,sho:80,pas:60,dri:74,def:38,phy:78,sm:3,wf:3,club:"Roma",           nat:"🏴󠁧󠁢󠁥󠁮󠁧󠁿",cat:"FWD"},
  {id:186,n:"Alexandre Lacazette",   s:"Lacazette",   pos:"ST",  r:83,pac:74,sho:83,pas:75,dri:78,def:44,phy:74,sm:3,wf:4,club:"Lyon",           nat:"🇫🇷",cat:"FWD"},
  {id:187,n:"Ilkay Gündoğan (CM)",   s:"Gündoğan CM", pos:"CM",  r:84,pac:64,sho:78,pas:87,dri:82,def:67,phy:69,sm:3,wf:4,club:"FC Barcelona",  nat:"🇩🇪",cat:"MID"},
  {id:188,n:"Dani Olmo (CM)",        s:"D. Olmo CM",  pos:"CM",  r:87,pac:83,sho:79,pas:84,dri:87,def:53,phy:71,sm:3,wf:3,club:"FC Barcelona",  nat:"🇪🇸",cat:"MID"},
  {id:189,n:"Emiliano Buendía",      s:"Buendía",     pos:"CAM", r:82,pac:73,sho:72,pas:79,dri:82,def:44,phy:64,sm:3,wf:3,club:"Aston Villa",   nat:"🇦🇷",cat:"MID"},
  {id:190,n:"Adrien Rabiot",         s:"Rabiot",      pos:"CM",  r:83,pac:74,sho:70,pas:80,dri:76,def:72,phy:80,sm:3,wf:3,club:"Marseille",     nat:"🇫🇷",cat:"MID"},
  {id:191,n:"Levi Colwill",          s:"Colwill",     pos:"CB",  r:84,pac:73,sho:43,pas:63,dri:57,def:83,phy:81,sm:2,wf:3,club:"Chelsea",       nat:"🏴󠁧󠁢󠁥󠁮󠁧󠁿",cat:"DEF"},
  {id:192,n:"John Stones",           s:"J. Stones",   pos:"CB",  r:84,pac:75,sho:52,pas:75,dri:68,def:85,phy:80,sm:2,wf:3,club:"Man City",      nat:"🏴󠁧󠁢󠁥󠁮󠁧󠁿",cat:"DEF"},
  {id:193,n:"Karim Adeyemi (LW)",    s:"Adeyemi LW",  pos:"LW",  r:84,pac:96,sho:76,pas:69,dri:82,def:34,phy:68,sm:4,wf:3,club:"B. Dortmund",   nat:"🇩🇪",cat:"FWD"},
  {id:194,n:"Jhon Durán (B)",        s:"Durán B",     pos:"ST",  r:83,pac:82,sho:82,pas:58,dri:74,def:36,phy:80,sm:3,wf:3,club:"Aston Villa",   nat:"🇨🇴",cat:"FWD"},
  {id:195,n:"Vitinha (CDM)",         s:"Vitinha CDM", pos:"CDM", r:88,pac:74,sho:72,pas:87,dri:86,def:61,phy:68,sm:3,wf:3,club:"Paris SG",      nat:"🇵🇹",cat:"MID"},
  {id:196,n:"Victor Osimhen",        s:"Osimhen",     pos:"ST",  r:87,pac:94,sho:88,pas:63,dri:82,def:41,phy:86,sm:3,wf:4,club:"Galatasaray",   nat:"🇳🇬",cat:"FWD"},
  {id:197,n:"K. Kvaratskhelia (LW)", s:"Kvara LW",    pos:"LW",  r:88,pac:91,sho:84,pas:81,dri:92,def:39,phy:73,sm:5,wf:3,club:"Paris SG",      nat:"🇬🇪",cat:"FWD"},
  {id:198,n:"Phil Foden (LW)",       s:"Foden LW",    pos:"LW",  r:88,pac:84,sho:84,pas:85,dri:89,def:56,phy:71,sm:4,wf:3,club:"Man City",      nat:"🏴󠁧󠁢󠁥󠁮󠁧󠁿",cat:"FWD"},
  {id:199,n:"Marquinhos (CDM)",      s:"Marquinhos M",pos:"CDM", r:88,pac:75,sho:52,pas:74,dri:64,def:88,phy:84,sm:2,wf:3,club:"Paris SG",      nat:"🇧🇷",cat:"MID"},
  {id:200,n:"Richarlison (LW)",      s:"Richarlison L",pos:"LW", r:83,pac:86,sho:80,pas:65,dri:78,def:44,phy:78,sm:3,wf:3,club:"Tottenham",     nat:"🇧🇷",cat:"FWD"},
];
...
const INIT={
  ...
  setup:[{name:"Player 1",team:"Alpha FC"},{name:"Player 2",team:"Beta United"},{name:"Player 3",team:"Gamma City"},{name:"Player 4",team:"Delta Kings"}],
  teams:[],
  queue:[],
...
function reducer(s,a){
  switch(a.type){
    ...
    case "SET_ROLE":   return{...s,role:a.role};
    ...
    case "START_AUCTION":{
      ...
      const[first,...rest]=q;
      const teams=a.setup.map(t=>({name:t.name||"Player",team:t.team||"Team",budget:a.cfg.pts,squad:[]}));
      return{...s,teams,queue:rest,history:[],skipVotes:[],formSlots:{},unsoldPool:[],ra1Unsold:[],selVotes:{},
        phase:a.cfg.needAuctioneer?"role":"auction",
        role:a.cfg.needAuctioneer?null:{bidder:0},
    ...
    case "SELL":{
      ...
      return{...s,teams,unsoldPool,skipVotes:[],
    ...
    case "SKIP":{
      ...
      return{...s,unsoldPool,current:{...cur,status:"skipped"},skipVotes:[],
    ...
    case "NEXT_PLAYER":{
      ...
      return{...s,queue:rest,banner:null,
    ...
    case "DISMISS_BANNER":{
      ...
      return{...s,banner:null,_nextPlayer:undefined,
        current:{uid:Date.now(),player:next,bid:1,bidderIdx:null,timerEnd:Date.now()+s.cfg.timer*1000,status:"active"}};
    }
    ...
    case "CONFIRM_RA1_SELECTION":{
      ...
      return{...s,phase:"ra1_auction",ra1Unsold,queue:rest,selVotes:{},
    ...
    case "CONFIRM_RA2_SELECTION":{
      ...
      const[first,...rest]=reaucQueue;
      return{...s,phase:"ra2_auction",queue:rest,selVotes:{},
...
export default function App(){
  ...
  const{phase,cfg,setup,teams,current,queue,history,skipVotes,role,banner,formation,formSlots,sqView,room,unsoldPool,ra1Unsold,selVotes,raPhaseLabel}=s;
  ...
  // In round 2, eligible = teams with <15 players
      ...
      <div style={{position:"relative",zIndex:1,display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",minHeight:"100vh",padding:"40px 20px",gap:0}}>
        ...
        {!rAction?(
          <div style={{display:"flex",flexDirection:"column",gap:12,width:"100%",maxWidth:340}}>
            <button onClick={()=>setRAction("create")} style={{...BTN("linear-gradient(135deg,#f59e0b,#d97706)"),padding:"18px 0",fontSize:16,letterSpacing:4,color:"#000",fontWeight:800}}>＋ CREATE ROOM</button>
            <button onClick={()=>setRAction("join")} style={{...BTN("rgba(255,255,255,.06)"),padding:"18px 0",fontSize:16,letterSpacing:4,border:"1px solid rgba(255,255,255,.12)"}}>⟶ JOIN ROOM</button>
          ...
          <div style={{width:"100%",maxWidth:400,display:"flex",flexDirection:"column",gap:14}}>
            ...
            <button onClick={()=>{
              ...
              dispatch({type:"PATCH",patch:{room:{id:joinCode,name:`Room ${joinCode}`}}});
              dispatch({type:"SET_SETUP",setup:[...s.setup.filter(t=>t.name!==myName),{name:myName,team:myTeamN}]});
              dispatch({type:"PATCH",patch:{phase:"config"}});
      ...
      <div style={{maxWidth:520,margin:"0 auto",padding:"24px 16px 60px",display:"flex",flexDirection:"column",gap:12}}>
        ...
        {setup.map((t,i)=>(
          <div key={i} style={{display:"flex",gap:7,alignItems:"center",padding:"10px 12px",background:"rgba(255,255,255,.03)",border:"1px solid rgba(255,255,255,.07)",borderRadius:13}}>
            ...
            {setup.length>2&&<button onClick={()=>dispatch({type:"SET_SETUP",setup:setup.filter((_,j)=>j!==i)})} style={{background:"none",border:"none",color:"#6b7280",cursor:"pointer",fontSize:20,flexShrink:0,lineHeight:1,padding:"0 4px"}}>×</button>}
          </div>
        ))}
  ...
  if(phase==="role") return(
    <div style={{...PG,alignItems:"center",justifyContent:"center"}}><style>{FONTS+ANIM}</style>
      <div style={{maxWidth:460,width:"100%",padding:"28px 20px",display:"flex",flexDirection:"column",gap:16,animation:"cardIn .4s ease"}}>
        ...
        <button onClick={()=>{dispatch({type:"SET_ROLE",role:"auctioneer"});dispatch({type:"PATCH",patch:{phase:"auction"}});setTab("bid");}} style={{background:"rgba(245,158,11,.06)",border:"2px solid rgba(245,158,11,.35)",borderRadius:20,padding:"18px 20px",cursor:"pointer",textAlign:"left",width:"100%",display:"block"}}>
        ...
        <div style={{background:"rgba(255,255,255,.03)",border:"1px solid rgba(255,255,255,.1)",borderRadius:20,padding:"14px"}}>
          ...
          {teams.map((t,i)=>(
            <button key={i} onClick={()=>{dispatch({type:"SET_ROLE",role:{bidder:i}});dispatch({type:"PATCH",patch:{phase:"auction"}});setTab("bid");}} style={{display:"flex",alignItems:"center",justifyContent:"space-between",padding:"10px 13px",borderRadius:12,background:"rgba(255,255,255,.04)",border:"1px solid rgba(255,255,255,.08)",cursor:"pointer",width:"100%",marginBottom:6}}>
              <div style={{display:"flex",alignItems:"center",gap:9}}>
                ...
                <div><div style={{fontFamily:F,fontWeight:700,fontSize:14,color:"#fff"}}>{t.team}</div><div style={{fontSize:10,color:"#6b7280"}}>{t.name}</div></div>
              </div>
    ...
    <div style={{...PG,height:"100dvh",overflow:"hidden"}}>
      ...
      <div style={{display:"flex",alignItems:"center",justifyContent:"space-between",padding:"8px 16px",borderBottom:"1px solid rgba(255,255,255,.06)",flexShrink:0,gap:8,flexWrap:"wrap",background:"rgba(5,7,14,.97)"}}>
        ...
        <div style={{display:"flex",alignItems:"center",gap:10}}>
          ...
          {cfg.needAuctioneer&&<button onClick={()=>dispatch({type:"PATCH",patch:{phase:"role"}})} style={{...BACK,fontSize:10,padding:"4px 10px"}}>SWITCH</button>}
        </div>
      </div>
            ...
            {["M","FWD","MID","DEF","GK"].map(cat=>{
              ...
              return(
                <div key={cat} style={{marginBottom:18}}>
                  ...
                  {cps.map((pl,i)=>{const g2=cardGrade(pl.r,pl.cat);const isLive=i===0&&pl===p;return(
            ...
            <div style={{flex:1,overflowY:"auto",padding:"16px 16px 80px"}}>
              {dashSub==="overview"&&(
                <div style={{display:"flex",flexDirection:"column",gap:12}}>
                  {teams.map((t,i)=>{const an=analyzeSquad(t.squad);const isMe=bidderIdx===i||(noAuc&&activeTi===i);return(
                    <div key={i} style={{background:`rgba(255,255,255,${isMe?.05:.02})`,border:`1px solid ${isMe?"rgba(245,158,11,.25)":"rgba(255,255,255,.06)"}`,borderRadius:18,overflow:"hidden"}}>
                      <div style={{padding:"12px 16px",borderBottom:"1px solid rgba(255,255,255,.04)",display:"flex",justifyContent:"space-between",alignItems:"center",background:isMe?"rgba(245,158,11,.04)":"transparent"}}>
                        <div>{isMe&&<span style={{fontSize:12}}>👤 </span>}<span style={{fontFamily:F,fontWeight:800,fontSize:16,color:"#fff"}}>{t.team}</span><span style={{fontSize:10,color:"#4b5563",marginLeft:8}}>{t.name}</span>
                      ...
                      <div style={{padding:"8px 14px 10px"}}>
                        ...
                        {t.squad.length>0&&<div style={{display:"flex",gap:5,overflowX:"auto"}}>
                          {[...t.squad].sort((a,b)=>b.r-a.r).slice(0,8).map((pl,pi)=>{const g2=cardGrade(pl.r,pl.cat);return(
                  ...
                  {[{k:"budget",l:"Budget",max:cfg.pts,c:"#60a5fa",f:v=>`${v}pt`},{k:"str",l:"Strength",max:99,c:"#f59e0b",f:v=>v||0},{k:"avgR",l:"Avg Rating",max:91,c:"#a78bfa",f:v=>v||"—"},{k:"total",l:"Players",max:20,c:"#34d399",f:v=>`${v}/20`},{k:"gks",l:"GKs",max:3,c:"#f59e0b",f:v=>v},{k:"defs",l:"Defenders",max:8,c:"#818cf8",f:v=>v},{k:"mids",l:"Midfielders",max:10,c:"#34d399",f:v=>v},{k:"fwds",l:"Forwards",max:8,c:"#f87171",f:v=>v}].map(stat=>{
                    ...
                    return(
                      <div key={stat.k} style={{background:"rgba(255,255,255,.02)",border:"1px solid rgba(255,255,255,.06)",borderRadius:14,padding:"12px 14px"}}>
                        ...
                        {vals.map(({t,v},i)=>{const isMe=bidderIdx===i||(noAuc&&activeTi===i);return(
              ...
              {dashSub==="log"&&(
                <div style={{display:"flex",flexDirection:"column",gap:5}}>
                  ...
                  {history.map((h,i)=>{const g2=cardGrade(h.player.r,h.player.cat);const m=CAT_META[h.player.cat]||CAT_META.FWD;return(
                    ...
                    return Object.entries(clubs).map(([club,pls])=>(
                      <div key={club} style={{marginBottom:12}}>
                        ...
                        <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:5}}>
                          {pls.map(pl=>{const placed=assignedUids.has(pl.uid);const g2=cardGrade(pl.r,pl.cat);return(
